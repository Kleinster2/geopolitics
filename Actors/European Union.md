...
founded: 1993 (EU), 1957 (EEC)
members: 27
headquarters: Brussels
tags: [IGO, regional, europe, economic-union]
---

# European Union

## Overview
The world's most advanced regional integration project, combining economic union with emerging political and security dimensions. Navigates between deeper integration and member state sovereignty.

## Key Facts
- **Founded**: 1993 (Maastricht Treaty); roots in 1957 EEC
- **Members**: 27 states
- **Population**: ~450 million
- **GDP**: ~$18 trillion (2nd largest economy)
- **Headquarters**: Brussels (main), Strasbourg, Luxembourg
- **Currency**: Euro (20 members in Eurozone)
...
- Fiscal rules (Stability Pact)

### Common Policies
- Trade (exclusive competence)
- Agriculture (CAP)
- Fisheries
...
| Country | Role |
|---------|------|
| Germany | Economic engine, largest member |
| France | Political/military leadership |
| Italy | Founding member, economic challenges |
| Spain | Major economy, Mediterranean voice |
| Poland | Largest Eastern member, contentious |
| Netherlands | Trade, fiscal conservatism |

## Enlargement
- **Candidates**: Ukraine, Moldova, Georgia, Western Balkans, Turkey (frozen)
- **Post-Brexit**: Smaller but more cohesive?
- **Strategic enlargement**: Geopolitical tool

## Brexit Impact
- UK departure (2020)
- Reduced size/influence
- Cohesion improved?
- UK-EU tensions persist
