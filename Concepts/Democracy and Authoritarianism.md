...
type: concept
category: political
tags: [concept, political, governance, democracy, authoritarianism]
---

# Democracy and Authoritarianism

## Overview
The fundamental divide in global governance between systems based on popular sovereignty, individual rights, and competitive elections versus those based on concentrated power, limited participation, and state control. This divide increasingly shapes international alignments, alliances, and competition.

## Definitions

### Democracy
Government by the people, characterized by:
...
### Authoritarianism
Concentrated political power, characterized by:
- Limited political competition
- Weak rule of law
- Restricted civil liberties
- State control of media
- Regime security priority

### Spectrum
```
Full Democracy → Flawed Democracy → Hybrid → Competitive Auth → Closed Auth
```
...
- Co-opt rather than just repress
- Managed elections
- Economic legitimacy
...
- Alienates non-democracies
- Ignores democratic failings
- Pragmatism vs. ideology

### Authoritarian Cooperation
- Russia-China alignment
- Mutual support at UN
- Technology sharing
...
- Reliable alliances (shared values)
- Economic dynamism
...
- Shared norms, transparency
- But: requires mature democracies
- And: democracies do fight non-democracies
...
### Democratic Concerns
- Platform regulation debates
- Disinformation vulnerability
- Privacy vs. security
- Tech company power

### "Splinternet"
- Internet fragmenting
...
- Project externally
- Exploit democratic openness
- Disinformation campaigns

### Democratic Vulnerability
- Free press exploitable
- Social media manipulation
- Polarization amplified
- Trust erosion
- See: [[Information Warfare]]

## Alliance Patterns

### Democratic Alignments
- NATO
- Quad
- AUKUS
- G7
...
- Conditionality (aid, trade)
- Election monitoring
- Civil society support

### Current Debates
- Effectiveness questioned
- Backlash against "imposition"
- Sovereignty concerns
- Hypocrisy charges
- Selective application

### Limits of Promotion
- Can't export democracy
- Must be domestic-driven
