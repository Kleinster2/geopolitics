...
### Existential Framing
- **Iran**: Israel as "illegitimate Zionist entity" to be destroyed
- **Israel**: Iranian nuclear program as existential threat
- Both view the other as implacable enemy
- No diplomatic relations since 1979

### Shadow War Characteristics
- Plausible deniability (mostly)
- Below war threshold
- Proxy utilization
- Assassinations and sabotage
- Cyber operations
- Occasional direct strikes

## Theaters of Operation

### Syria
- Israel strikes Iranian/Hezbollah targets
- Hundreds of strikes since 2013
- "Campaign Between Wars"
- Prevent weapons transfers
- Degrade Iranian presence

### Lebanon
- Hezbollah as primary front
- Israeli surveillance
- Periodic conflicts (2006)
...
### High Seas
- Ship attacks (Iranian/Israeli-linked)
- Shadow naval warfare
- Persian Gulf incidents
- Mediterranean operations

### Global
- Attacks on Iranian/Israeli targets worldwide
- Embassy bombings (attributed)
...
| Target | Date | Method |
|--------|------|--------|
| Mohsen Fakhrizadeh | Nov 2020 | Remote weapon |
| Multiple scientists | 2010-2012 | Bombings |
| Natanz sabotage | 2020, 2021 | Explosions |

#### Cyber
- **Stuxnet (2010)**: Destroyed centrifuges (with US)
- Ongoing operations assumed
...
### Syria Campaign
- 100+ strikes annually
- Iranian bases targeted
- Weapons convoys destroyed
- Hezbollah warehouses

### Lebanon/Hezbollah
- Surveillance
- Targeted killings
- 2024: Devastating campaign
- Nasrallah assassination

## Iranian Operations

### Proxy Attacks
- Hezbollah rockets/missiles
- Iraqi militia attacks on US (Israel-adjacent)
- Houthi missiles toward Israel
- Hamas/PIJ operations

### Direct Plots
- Failed attacks on Israeli tourists
- Embassy targeting (attempted)
- Diaspora targeting
- 2024: Direct missile/drone attack
...
- No direct state-on-state attacks
- Proportional responses
- Geographic limitations
- Avoid full war

### Eroding Rules
- Direct attacks normalized (2024)
- Leadership targeting accepted
...
- Iran adversary
- Restraint pressure
- Military option (reserved)

### Regional States
- Gulf: Anti-Iran but cautious
- Jordan: Intercepted Iranian attack
- Saudi: Quiet coordination with Israel
- Turkey: Balancing
