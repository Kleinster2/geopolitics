...
# 2026 Iran conflict -- analyst perspectives

Analyst assessments of the [[2026 Iran conflict]] (Operation Epic Fury). Split from the main conflict note for navigability. For timeline, casualties, and strategic assessment, see the parent note.
...
### Ali Vaez (International Crisis Group) — March 14, 2026

**Source**: *The Ezra Klein Show* interview (101 min). Vaez is ICG Iran project director, nuclear scientist, involved in JCPOA negotiations, co-author of *How Sanctions Work: Iran and the Impact of Economic Warfare*.

**On the ring of fire and October 7th — the miscalculation chain:**
- In 2023, Iran was building a concept called the **ring of fire** — simultaneous four-front pressure on Israel (Hezbollah, Hamas, Houthis, Iraqi militias). Tested April 2023; Iran concluded **they were not ready**.
- Soleimani's 2020 assassination removed the one person with personal authority to tell proxy leaders "not yet." No replacement had the relationships or charisma.
- Sinwar — operating with more autonomy than under Soleimani — launched October 7th on his own timeline, before the multi-front system was operational.
- Iran endorsed but tried to distance from October 7th — "a distinction without a meaningful difference" since Hamas was clearly financed, trained, and supported by Iran.
- Khamenei subcontracted regional strategy to Nasrallah, believing "an Arab in that part of the world understands it better than Persians a thousand kilometers away."
- After Israel escalated in Syria (killing IRGC commanders, then hitting Iran's Damascus consulate in April 2024), Khamenei launched hundreds of missiles/drones at Israel — first ever direct attack from Iranian soil. But telegraphed it in advance to minimize casualties, signaling willingness to cross a red line without signaling strength.
- Result: opened direct confrontation with a far superior military, leading to the chain that killed him.
- Core failure: Iran subcontracted its regional foreign policy to non-state actors with "fundamentally different interests." When the coordinating hand was removed, the proxies freelanced.

**On the Kushner-Witkoff negotiations — why they were doomed:**
- Vaez has now reviewed post-negotiation briefings by Kushner and Witkoff. His conclusion: "these negotiations were always doomed to fail."
- Witkoff was "surprised that the Iranians could manufacture their own centrifuges." He described the IR-6 as "probably the most powerful centrifuge in the world" — **(incorrect)**.
- They "often didn't take even experts with them." Expected a yes/no answer, not complex technical negotiation.
- The Iranians, by contrast, were "desperate for a deal" — came with working papers, put ideas on the table, were willing to give Trump more than they gave Obama.
- But Trump demanded capitulation. For a regime whose founding mythology is safeguarding Iran's independence — that lost half a million in the Iran-Iraq War to avoid losing territory — surrender was more perilous than strikes. The 5-10% core constituency that still supports the regime would be alienated, leaving them with nothing.
- **Trust destroyed three times**: Trump withdrew from JCPOA (2018), bombed Iran during negotiations (2025), bombed again during negotiations (2026).

**On Iran's outlasting strategy:**
- Iran knows it's outgunned but believes it can outlast. "Imagine the 12-day war last year. Iran lost about a thousand citizens and portrayed it as victory because it survived. If there are a thousand American or Israeli casualties, there's no way that could be portrayed as a win."
- **Interceptor depletion**: In the first days of this war, Iran tried to deplete Gulf states' and Israel's interceptor arsenals as quickly as possible, "so that once they bring out their more powerful missiles, they can hit targets much more effectively."
- **Horizontal escalation**: Spread pain to region and global economy — energy disruption. If production facilities are targeted/destroyed (not just shipments disrupted), "the price of oil will go above $200 a barrel."
- Strategy based on stretching the timeline — attrition works for Iran if regime survives.

**On endgame scenarios:**
1. **Iraq 1991 parallel** (Vaez's baseline): Regime wounded but standing. Sanctions-based containment follows. But in Iraq, 12 years of containment destroyed the social fabric — even when Saddam was removed (2003), the country couldn't be put back together. "America paid a very high price for that in blood, treasure, and reputation."
2. **Venezuela model** (Trump's stated preference): Negotiated transition where "everybody kept their job except two people." Problem: in Venezuela, negotiation preceded military action. In Iran, it would have to follow it. No Iranian official will trust Trump after three betrayals.
3. **Libya parallel** (worst case): State breaks apart along ethno-sectarian fault lines or between rival generals (Sudan analogy). "Disaster for the rest of the region and world security."
4. **Nuclear breakout**: Half a ton of 60% enriched uranium remains — enough for ~4 Hiroshima-type weapons or ~10 warheads. Mojtaba Khamenei "might decide his father was wrong about hesitating to take the last step." Vaez: "I almost have no doubt the regime will be determined to try to develop nuclear weapons" — every precedent (Iraq, Libya, North Korea, Ukraine) points in one direction.
5. **Great power pivot**: If Iran survives, Russia and China will start looking at Iran differently — as a shield against US domination of the Middle East. "Turns Iran into an arena of great power competition without the United States having any plan other than containment."

**On the hardliner feedback loop (historical pattern):**
- Pattern across 47 years: Iranian hardline actions empower hawks in opposing countries, whose responses empower Iranian hardliners.
- Hostage crisis → Reagan; Hamas/Hezbollah funding → Netanyahu empowered; Khatami engagement rejected → reformists discredited; JCPOA compliance → Trump withdrawal vindicated hardliners.
- "This institutionalized enmity always benefits the hawks on all sides more than the moderates who tried to change course."

**On broken promises — why Iran doesn't trust the US:**
- Algiers Accord (1981): US didn't deliver on non-interference or asset return.
- Lebanon hostages (1990s): Iran helped release US hostages; Bush Sr. didn't reciprocate.
- Clinton era: Iran offered oil contract to US companies; Clinton imposed ILSA sanctions instead.
- Post-9/11: Soleimani prepared Afghanistan for US jets; Bush named Iran in "Axis of Evil."
- JCPOA: Obama didn't fully deliver sanctions relief; Trump withdrew entirely.
- Biden prisoner deal: $6B unfrozen; Biden froze access after Oct 7th (money was unrelated to proxies).
- "No Iranian official is going to trust him. He also humiliated Venezuela."

**On the Gulf states' dilemma:**
- Arab neighbors angry at Iran for firing at them — but also angry at the US for starting this.
- Worried about a region with no power left to challenge Israeli hegemony. "They were against Iranian hegemony, but they're also uncomfortable and against Israeli hegemony."
- Collapse of Iran = last obstacle to unchecked Israeli power projection removed.

**On US planning:**
- "The US followed Israel into this and was hoping the day after would arrive very quickly and would magically work." Vaez: "Hope is not a strategy."
- No US strategy for the day after. Israel is comfortable with any outcome (wounded Iran, collapsed Iran, restored monarchy). The US is not — but hasn't thought through the long tail.
- 1953 coup's lesson: "short-term victories, even if achievable, sometimes come back to haunt you down the road."

**Book recommendations:**
- Lloyd Llewellyn-Jones, *The Persians: Age of the Great Kings* — Persian history from Persian (not Greek) sources
- Roy Mottahedeh, *The Mantle of the Prophet: Religion and Politics in Iran* — texture of post-revolutionary society
- Hussein Agha & Rob Malley, *Tomorrow is Yesterday: Life, Death, and the Pursuit of Peace in Israel/Palestine* — how all sides' narratives sustain Gordian knots

**Assessment**: This is Vaez's most comprehensive public analysis of the conflict. The March 8 Channel 4 interview (below) focused on succession and attrition dynamics. The Klein interview goes deeper: the ring of fire concept, the Soleimani-gap → October 7th chain, inside knowledge of the Kushner-Witkoff negotiation failure, and a historically grounded framework for endgame scenarios. His most distinctive argument: Iran's miscalculations were structural (subcontracting foreign policy to proxies with different interests) rather than ideological, and the JCPOA's theory of change — middle class expansion enabling generational transition — was never tested because it was destroyed by American domestic politics. Compare with Bohl's more operational focus on military dynamics and regime resilience; Vaez provides the political-historical architecture. His endgame taxonomy (Iraq 91 / Venezuela / Libya / nuclear breakout / great power pivot) is the most comprehensive framework in this collection. The nuclear breakout scenario is his most alarming: half a ton of 60% uranium already exists, and "every historic precedent teaches them that's the only way to create a shield for survival."
...
### Marc Lynch (George Washington University) — March 5, 2026

**Source**: "The United States Could Lose the Gulf," *Foreign Policy*

Lynch argues the war represents both the apotheosis and potential collapse of America's Middle East order: Washington always wanted Arab-Israeli cooperation against Iran without resolving the Palestinian issue — and now has it, just as the region may be collapsing.

**Iran's three-level Gulf strategy** — Lynch argues Iran's targeting is rational, not random:
1. **Shatter civilian immunity** — targeting civilian centers to demonstrate Gulf populations' unprecedented vulnerability.
2. **Cause global economic pain** — closed Hormuz "without much effort, simply by making threats that oil tankers did not care to test." Saudi refineries and Qatari LNG shut down even without direct attacks.
3. **Exhaust missile defense** — cheap drones/Shaheds in waves while targeting radar and communications. "No one should be fooled by high rates of missile defense success early on... The real test comes as interceptors run out."

**Why Iran escalated vs. June 2025**: During the Twelve-Day War, Gulf states stayed on the sidelines and Iran held back. With a US-Israeli regime-change war, "the benefits offered by the rapprochement with Saudi Arabia were already gone." Iran didn't feel rewarded for restraint the last time.

**Gulf betrayal by Trump specifically**: Lynch argues the sense of betrayal is acute because Gulf leaders thought they had *better* relations with Trump than any previous president — his financial interests, preference for autocracy, personalistic style. Specific grievances: war launched without consultation, US impotence at protecting oil installations and shipping, inability to resupply interceptors, and US bases becoming "a source of threat rather than security."

**Saudi-Emirati split — paused, not resolved**: The war interrupted the most significant reshuffling of regional order in years — Saudi Arabia was building a new alliance with Turkey, Qatar, Egypt, and Pakistan while pushing back against the UAE and, by proxy, Israel. Had Iran targeted only the UAE and Bahrain, "Saudi Arabia and its new partners might well have thrown the Abraham Accords states to the wolves." Iran's attacks on all Gulf states reunified them temporarily. But underlying issues remain — Israel's unchecked war will exacerbate Arab fears of being next.

**Gulf identity shattered**: Iran brought wealthy Gulf citizens "firmly, and likely permanently, back into geographical reality." The human price of regional power politics was supposed to be paid by Syrians and Yemenis — not by them.

**Assessment**: Lynch brings deep institutional knowledge of Gulf politics that other conflict analysts don't match. His most distinctive contribution is the Saudi-Emirati split analysis — none of the other analysts describe the pre-war Saudi realignment in such detail. The argument that Iran's broad targeting accidentally rescued the Abraham Accords coalition is analytically novel. Complements [[Karen Young]]'s GCC existential threat framing with the political dimension. Extends [[Vali Nasr]]'s Israeli ambitions analysis to the Gulf states' own perception. Compare with [[Ryan Bohl]]'s post-war Saudi-UAE divergence prediction: Bohl flags the fault line as emerging post-war; Lynch shows it was already active before the war started.
...
### Michal Meidan (OIES) — March 2026

**Source**: "Disruption in the Strait of Hormuz: Implications for China's Energy Markets and Policies," OIES Energy Comment, March 2026

**China's Gulf exposure:**
- ~50% of China's crude imports come from the Middle East. Iran specifically: 0.84 mb/d in 2025 (Kpler data), down from 1.2 mb/d in 2024 — officially zero, but tracked via tanker data.
- Qatar = 27% of China's LNG imports, but only 15% of net imports and 6% of total gas demand.
- Middle East supplies 40% of China's naphtha imports and 45% of LPG.
- As share of refining needs, Middle Eastern crude = ~1/3 of demand (when including domestic production).

**Most exposed sectors:**
- **Independent "teapot" refiners in Shandong** — biggest importers of Iranian crude, already hit by loss of Venezuelan crude marketing changes. Loss of discounted Iranian barrels directly compresses margins.
- **Chemicals industry** — Meidan argues this is "the most underappreciated impact." Naphtha (7% of total demand from ME imports) and LPG (18% of total consumption from ME) feed into petrochemicals.
- **Gas-reliant provinces** — Guangdong, Jiangsu, Shanghai, Zhejiang have comparatively large shares of gas in their power mix. Protracted gas crisis means higher costs from switching to coal/renewables.

**China's buffers:**
- Large crude stocks (commercial + strategic). But SPR release mechanism only tested once (September 2021) — logistical issues with location and pricing; not all auctioned cargoes were sold.
- Underground gas storage at 27 bcm (6.3% of consumption, end-2024) — far short of the 55-60 bcm target in the 14th Five Year Plan. LNG terminal storage adds ~11.2 bcm buffer.
- Power sector flexibility: gas = small share of generation; coal, hydro, and renewables can absorb shortfall.
- US LNG potentially "in the money" despite 25% tariff — Henry Hub + tariff still below Asian spot prices.

**Pre-emptive measures already underway:**
- China told state-owned refiners to halt diesel and gasoline exports (Bloomberg, March 5, confirmed).
- Refiners cutting runs. Chemical companies and gas-dependent industrials reducing operating rates.
- Importers lining up alternative supplies.

**Assessment**: Meidan heads OIES's China Energy Research Programme — one of the most credentialed China energy analysts in the field. Her contribution is data-specific in ways that broader geopolitical analysts don't match: the precise import shares, the teapot refiner vulnerability, the SPR mechanism's untested status, and the gas storage gap. Her argument that chemicals/LPG is the underappreciated impact adds a dimension absent from Western-focused energy analyses (which focus on crude). Compare with [[Karen Young]]'s GCC energy analysis: Young focuses on Gulf production/export disruption; Meidan focuses on the demand-side impact in China — together they map the full supply chain disruption.

### Sanam Vakil (Chatham House) — March 14, 2026

**Source**: "The war on Iran is heading for an Iraq-style stalemate," *Financial Times*

**The Iraq 1991 parallel:**
- Vakil argues the most likely outcome is not regime change but an **Iraq-after-1991 scenario**: Iran militarily defeated and economically debilitated, yet still governed by a reconstituted form of the same regime.
- Washington's objectives are incoherent — at different moments framed as destroying nuclear capabilities, weakening military/proxies, or enabling regime change. "These are very different goals that point to very different endgames."
- The regime quickly appointed a successor, continued retaliatory strikes, and demonstrated its decentralized military structure works as designed.
- New US intelligence estimates suggest military success is unlikely to produce political change in Tehran.
- IRGC plays the same role as Saddam's Republican Guard — combining military, economic power, and ideological commitment to regime survival.

**The 1991 precedent in detail:**
- Coalition forces expelled Iraqi troops from Kuwait and destroyed much of Saddam's military, but stopped short of overthrowing him.
- Bush publicly encouraged Iraqis to rise up. Shia in the south and Kurds in the north did so. The uprisings were brutally suppressed by the Republican Guard.
- What followed was not regime change but a decade of containment: sanctions, weapons inspections, no-fly zones, periodic strikes. Iraq existed in "strategic limbo."
- Sanctions hollowed out state institutions. Citizens were hit harder than the regime, which adapted by tightening control over dwindling resources. Humanitarian consequences were severe.
- This containment ultimately culminated in the 2003 US-led invasion.

**Implications for Iran:**
- Iran's civilians will bear the costs: wartime destruction + sanctions = currency collapse, hyperinflation, new migration flows toward Turkey, Iraq, Gulf states, Europe.
- Tehran is signaling dissent will be treated as collaboration with external enemies — protests will be met with even harsher repression.
- Iran will lose regional reach and financial ability to support Houthis and Hezbollah, while strengthening internal repression.

**The structural warning:**
- Frozen conflicts drift back toward war. Unresolved issues resurface, leading to recurring crises, periodic escalation, and "inevitable pressure in the US and Israel to 'finish the job.'"
- The 1991-2003 cycle is the template: containment that resolves nothing and generates pressure for a larger, more destructive conflict.

**Assessment**: Vakil directs Chatham House's MENA Programme — among the most institutionally credentialed positions in UK foreign policy analysis. Her Iraq 1991 parallel is her distinctive contribution and fills a gap in the analyst roster: most other analysts have compared this to Iraq 2003 (Parsi), post-war scenarios (Bohl, Kagan), or regional order restructuring (Nasr, Vizier Report). Vakil is the first to argue the most likely outcome is neither regime change nor indefinite war, but a **decade-long strategic limbo** that ends in a second, larger war — the 1991-to-2003 trajectory. Her framing of incoherent US objectives echoes Nasr but leads to a different conclusion: Nasr sees an Israeli-driven agenda; Vakil sees a structural drift toward containment without strategy. Her warning about the humanitarian cost of containment (sanctions hollowing out institutions while the regime adapts) draws directly from the empirical Iraq record and adds moral weight absent from most military-focused analyses. Compare with Kagan's "pragmatist survival" warning: both identify regime survival as the likely outcome, but Kagan frames it as a risk to manage while Vakil frames it as the beginning of a new, longer crisis cycle.

### Roxane Farmanfarmaian & Burcu Ozcelik (RUSI) — January 19 / March 8, 2026

**Sources**: "Is Iran at a Tipping Point? Protest, Military Escalation and Regime Survival," RUSI Commentary (January 19); "Goldilocks" analysis, *The Observer* (March 8)

**Pre-war conditions (January 19 — six weeks before the strikes):**
- This protest cycle was "qualitatively different" — a structural stress test of state capacity, elite cohesion, and deterrence. Regime killed 2,500+ protesters (contested; up to 16,500 feared amid internet blackout).
- Regime legitimacy "does not need to be universal to sustain an autocracy, but it does need to be sufficient to reduce the everyday costs of rule." That reservoir was thinning — state relied more on fear and fatigue than consent.
- No credible high-level defections or elite IRGC unit activation at that point — the regime was "still operating within familiar coercive parameters, containing unrest without yet revealing the deeper vulnerabilities that often precede systemic rupture."
- Israeli claims about operatives among protesters (far-right minister, Channel 14, Pompeo) — whether psychological operations or not — gave the regime rationale for its worst crackdown. Once protests were framed as externally orchestrated, "the threshold for repression dropped and the scope for de-escalatory bargains narrowed."
- For the first time in protest history, the Army (Artesh) publicly stated it would protect Iran's strategic assets — the external threat framing unified the security apparatus.

**On regime collapse vs. transition:**
- The concept of regime collapse is "quite problematic." More likely: "some sort of transition, whether led by one individual or a constellation of leaders across the security forces and intelligence."
- A deeper contest was underway over what "Iran" is for: velayat-e faqih and revolutionary export, or national renewal, dignity, and prosperity. Slogans like "No to Gaza; no to Lebanon; my life only for Iran" captured sharpened Iran-first nationalism.

**On US options and credibility:**
- US was "very likely assessing its options and, critically, whether limited kinetic action against elements of the regime's security apparatus can shape events inside Iran that can accelerate the conditions for political transition."
- Regime change would require a "large-scale, sustained campaign maintained long enough to fracture the coercive apparatus" — sits "uneasily with President Trump's apparent preference for short, demonstrably 'winnable' operations with clear endpoints."
- "If Washington ultimately opts not to act after publicly signalling support for civilian protesters, the precedent is easy to anticipate. Future US statements of solidarity will be read as non-credible."

**Wartime "Goldilocks" framing (Ozcelik, March 8):**
- The US-Israel gamble is to bring Iran to near-but-not-complete collapse: "regime transformation — something short of total state collapse, but still a decisive alteration in how state power is organised, exercised and enforced."
